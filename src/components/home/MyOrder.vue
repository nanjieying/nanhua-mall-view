...
<Layout class="layout">
  <nav-bar title="我的订单" />
    <div class="page-card">
      ...
      <div class="page-size">
        <Page :total='orderTotal' :current="1" @on-change="changePage"></Page>
      </div>
    </div>
      ...
      columns: [
        ...
        },
        {
          ...
          render: function (h, params) {
            let date = new Date(this.row.gmtCreate);
            return h('div', {props: {}},
        ...
        },
        {
          ...
          align: 'center',
          render (h, param) {
            const orderStatus = this.row.orderStatus;
            let orderStatusStr = '';
            if (orderStatus === 0) {
              orderStatusStr = '待付款';
        ...
        },
        {
          ...
          width: 120,
          render (h, param) {
            const orderNumber = this.row.orderNumber;
