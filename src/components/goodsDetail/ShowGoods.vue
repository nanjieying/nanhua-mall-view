            ...
            <div class="item-price-row">
              <p v-if="getPromotionList != null">
                ...
                <span
                  ...
                  :key="index"
                  >满{{ item.fullPrice }}减{{ item.reducePrice }}</span
                >
              </p>
            </div>
          </div>
          ...
          <div class="item-select-container">
            ...
            >
              <div
                ...
                :class="{ 'item-select-box-active': item.active == true }"
              >
                <!-- 规格项值 图片 -->
                <div
  ...
  computed: {
    ...
    select_ids() {
      ...
      this.getGoodsDetailBase.specList.forEach(item =>
        item.optionDTOS.filter(e => e.active).forEach(e => ids.push(e.id))
      );
      return ids;
    }
  },
    ...
    select(id, index, i) {
      ...
      */
      ...
      this.getGoodsDetailBase.specList[index].optionDTOS.forEach(item => {
        if (item.id === id) {
          this.getGoodsDetailBase.specList[index].optionDTOS[i].active = true;
        } else {
          item.active = false;
        }
      });
